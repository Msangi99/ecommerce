                ...
                <tbody class="divide-y divide-slate-100 text-sm">
                    @forelse($purchases as $purchase)
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-6 py-3 font-bold">{{ number_format($purchase->quantity * $purchase->unit_price, 2) }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-center text-slate-500">No purchases found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
