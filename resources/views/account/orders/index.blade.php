<x-account-layout>
        ...
        <div class="space-y-6">
            @foreach($orders as $order)
                <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
                    <!-- Order Header -->
                    <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 rounded-t-lg flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div class="flex gap-8">
                            ...
                            <div>
                                ...
                                <span class="text-sm text-gray-900 truncate max-w-[150px]" title="{{ $order->address ? $order->address->address : ($order->shipping_address ?? 'N/A') }}">
                        ...
                        <div class="space-y-4">
                             @foreach($order->items as $item)
                                <div class="flex gap-4">
                                     <div class="flex-shrink-0 w-20 h-20 border border-gray-200 rounded-md overflow-hidden bg-gray-50">
                                         @php
    ...
    @else
        <div class="text-center py-12 bg-white rounded-lg border border-gray-200">
            ...
            <div class="mt-6">
                <a href="/" class="text-sm font-medium text-blue-600 hover:text-blue-500">Start shopping<span aria-hidden="true"> &rarr;</span></a>
            </div>
        </div>
    @endif
</x-account-layout>
